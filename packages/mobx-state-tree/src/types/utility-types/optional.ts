...
export type IOptionalValue<C, S, T> = S | T | IFunctionReturn<S> | IFunctionReturn<T>
...
export function optional<C, S, T>(type: IType<C, S, T>, defaultValueOrFunction: S): IType<C, S, T>
export function optional<C, S, T>(type: IType<C, S, T>, defaultValueOrFunction: T): IType<C, S, T>
